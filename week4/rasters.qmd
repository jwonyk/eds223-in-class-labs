...
# Approach 1: find the Cell ID for the point
...
# Verify that output has fewer values that original
...
```{r}
# Create raster mask of the some resolution and extent
rmask <- zion_elevation

# Set all cells with elevation less than 20000 meters to NA
rmask[rmask < 2000] <- NA
...
```{r}
zion_elevation + zion_elevation # Doubling each cells value
...
# This add one row to the top and to the bottom, and 200 columns on each side.
